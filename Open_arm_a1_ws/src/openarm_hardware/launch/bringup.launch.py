...
# openarm_hardware/HeadHW for real. All ros2_control + MoveIt config this
# launch needs lives in openarm_hardware/config/ (copied from arm_control
...
def launch_setup(context, *args, **kwargs):
    hw_config_pkg = get_package_share_directory("openarm_hardware")
